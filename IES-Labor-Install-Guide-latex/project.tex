...
\begin{enumerate}[label=\arabic*.,leftmargin=1.5em,itemsep=0.3em]
  \item Bearbeiten Sie die VM über den „Edit"-Button
\end{enumerate}
...
\begin{enumerate}[label=\arabic*.,leftmargin=1.5em,itemsep=0.3em,start=2]
  \item Aktivieren Sie unter System die Option „Force Multicore"
  \item Deaktivieren Sie unter QEMU die Option „UEFI-Boot"
\end{enumerate}
...
\begin{enumerate}[label=\arabic*.,leftmargin=1.5em,itemsep=0.3em,start=4]
  \item Setzen Sie unter Sharing den „Directory share mode" auf \textbf{SPICE WebDAV}
\end{enumerate}
...
\begin{enumerate}[label=\arabic*.,leftmargin=1.5em,itemsep=0.3em,start=5]
  \item Klicken Sie bei Path auf "Browse..." und wählen Sie einen neuen Ordner aus (dieser muss vorher erstellt werden)
\end{enumerate}
